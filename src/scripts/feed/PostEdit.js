// create an edit form. This component will look just like the PostEntry 
// except the function will accept a post object. 
// We can use the properties of the object to populate the input values. 
// We can also hold on to values in hidden fields.
